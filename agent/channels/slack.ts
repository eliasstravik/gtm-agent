...
import { getConfiguration, resolveSlackConfiguration, type Configuration } from "../lib/config.ts";
...
export default slackChannel(createSlackChannelConfig(resolveSlackConfiguration()));
